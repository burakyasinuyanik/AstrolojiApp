...
//VALUES
//    ('Ateş Grubu', '/Ui/assets/img/atesGrubu.jpg', 'Koç,Aslan,Yay'),
//    ('Toprak Grubu', '/Ui/assets/img/toprakGrubu.jpg', 'Boğa,Başak,Oğlak'),
//    ('Hava Grubu', '/Ui/assets/img/havaGrubu.jpg', 'İkizler,Terazi,Kova'),
//    ('Su Grubu', '/Ui/assets/img/suGrubu.jpg', 'Yengeç,Akrep,Balık')
...
//VALUES
//    ('Koç', '/Ui/assets/img/koc.jpg', '21 Mart - 19 Nisan'),
//    ('Boğa', '/Ui/assets/img/boga.jpg', '20 Nisan - 20 Mayıs'),
//    ('İkizler', '/Ui/assets/img/ikizler.jpg', '21 Mayıs - 20 Haziran'),
//    ('Yengeç', '/Ui/assets/img/yengec.jpg', '21 Haziran - 22 Temmuz'),
//    ('Aslan', '/Ui/assets/img/aslan.jpg', '23 Temmuz - 22 Ağustos'),
//    ('Başak', '/Ui/assets/img/basak.jpg', '23 Ağustos - 22 Eylül'),
//    ('Terazi', '/Ui/assets/img/terazi.jpg', '23 Eylül - 22 Ekim'),
//    ('Akrep', '/Ui/assets/img/akrep.jpg', '23 Ekim - 21 Kasım'),
//    ('Yay', '/Ui/assets/img/yay.jpg', '22 Kasım - 21 Aralık'),
//    ('Oğlak', '/Ui/assets/img/oglak.jpg', '22 Aralık - 19 Ocak'),
//    ('Kova', '/Ui/assets/img/kova.jpg', '20 Ocak - 18 Şubat'),
//    ('Balık', '/Ui/assets/img/balık.jpg', '19 Şubat - 20 Mart')
